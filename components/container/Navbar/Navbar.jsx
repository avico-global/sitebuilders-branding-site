                    ...
                    <div className='flex justify-between items-center py-4 md:py-1 '>
                        ...
                        <div className='flex flex-row gap-4 items-center min-w-0 '>
                            ...
                            <div className='hidden xl:flex flex-row gap-4 items-center text-base whitespace-nowrap'>
                                ...
                                <Link href="/resources" className='flex items-center'>Resources</Link>
                            </div>
                        </div>
                        {/* Right side */}
        ...
        return (
            <div className="bg-white w-full h-screen flex flex-col overflow-y-auto pb-64">
                <div className="flex flex-col w-full">
                    ...
                    {/* Pricing Link */}
                    <Link href="/pricing" className="px-6 py-4 text-base border-b border-gray-200 transition-colors duration-200 hover:bg-gray-50">Pricing</Link>
                    {/* Templates Link */}
                    <Link href="/templates" className="px-6 py-4 text-base border-b border-gray-200 transition-colors duration-200 hover:bg-gray-50">Templates</Link>
                    {/* Login Link */}
                    <Link href="/about-us" className="px-6 py-4 text-base border-b border-gray-200 transition-colors duration-200 hover:bg-gray-50">About us</Link>
